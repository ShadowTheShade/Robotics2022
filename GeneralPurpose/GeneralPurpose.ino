...
#define PICKUP_1 CRC_PWM_9 //Variable for pwm pin 9(servo) on the CrcDuino
#define DROPOFF_1 CRC_PWM_10 //Variable for pwm pin 10(servo) on the CrcDuino
#define SUSPICIOUS_ADDITION_1 CRC_PWM_11
